   ...
   navbarPage("Covid-19 ICU and Floor Projection",
              ...
              tabPanel("Documentation",
                       fluidPage( # Can uncomment if you want the images again
                          mainPanel(
                             p("Please cite as", em("Teng Zhang et al. A model to estimate bed demand for COVID-19 related hospitalization. medRxiv doi:https://doi.org/10.1101/2020.03.24.20042762")),
                             h5(a(href='https://doi.org/10.1101/2020.03.24.20042762', "Link of the paper",
                               target = '_blank')),
